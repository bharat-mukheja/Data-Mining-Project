...
def loadset():    
    reader = csv.reader(open('movie_details3.csv', 'r'))
    ...
    for count,row in enumerate(reader):
       Number,Year,Title,Genre,Rated,Type,imdbRating,Runtime,Director,Writer,Actors,Language,Country,Awards,imdbVotes,imdbID= row       
       if count >0:
    ...
    reader = csv.reader(open('movie_details3.csv', 'r'))
    with open('Transformed.csv', 'wb') as mycsvfile:
        ...
        for count,row in enumerate(reader):
            ...
            if count >0 :
                ...
                new_row=Number,Year,Title,avg_gen,Rated_set[Rated],Type_set[Type],Runtime_strip,Director_set[Director],avg_writer,avg_actor,avg_lan,avg_con,Awards_sum,imdbceil                
                thedatawriter.writerow(new_row)
            else:
                thedatawriter.writerow([Number,Year,Title,Genre,Rated,Type,Runtime,Director,Writer,Actors,Language,Country,Awards,imdbRating])
